  ...
  return {
    "highlight": {
      ...
      "author": {
        "id": "1234",
        "name": "Aquila Silva",
        "imageSrc": "https://i.postimg.cc/V6kZDcFk/Screenshot-2024-10-27-123629.png"
      },
      "read_time": 6,
      "media": {
        "type": "image",
    ...
    "latest_news": [
      {
        ...
        "initialText": "Na universidade experimentamos o primeiro sopro de independência, um ...",
        "read_time": 3,
        "media": {
          "type": "image",
      ...
      {
        "id": "63f2b1c4",
        "title": "Resistência e conquista: Os desafios dos povos indígenas na universidade",
        "initialText": "Na simbologia das formas, o círculo representa para muitos estudiosos ...",
        "read_time": 5,
        "media": {
          "type": "image",
      ...
      },
      {
        ...
        "initialText": "Imagine só, na sociedade em que vivemos, até a mais “Valente” das princesas ...",
        "read_time": 5,
        "media": {
          "type": "image",
    ...
    "recent_updates": [
      ...
      {
        "id": "63f2b1c8",
        "title": "Educando sobre maconha: Associações e comunidade acadêmica lutam pela conscientização ...",
        "read_time": 5,
        "media": {
          "type": "image",
    ...
    "latest_posts": [
      ...
      {
        "id": "63f2b1c6",
        "title": "Marcha da Consciência Negra celebra avanços e critica a violência",
        "author": {
          "id": "5678",
          "name": "José Soares"
        },
      ...
      {
        "id": "63f2b1c9",
        "title": "Projeto Escravizadores: 33 autoridades brasileiras têm antepassados ligad...",
        "author": {
          "id": "6789",
          "name": "Cláudia Mendes"
        },
        ...
        "media": {
          "type": "image",
          "url": "https://apublica.org/wp-content/uploads/2024/11/Capa_Projeto-Escravizadores-39-autoridades-brasileiras-tem-antepassados-ligados-a-escravidao.png",
          "alt": "Imagem do projeto escravizadores"
        },
        "published_at": "2024-10-21T15:00:00",
        "tag": "Notícia"
      },
      {
        "id": "63f2b1ca",
        "title": "Entrevista: Luta contra escala 6x1 é reação a 10 anos de ...",
        "author": {
          "id": "7890",
          "name": "Lucas Oliveira"
        },
        ...
        "media": {
          "type": "image",
          "url": "https://i.ibb.co/mNTNWPk/Fim-escala-6x1.png",
          "alt": "Imagem de alerta sobre golpes"
        },
        "published_at": "2024-10-21T16:00:00",
        "tag": "Notícia"
      }
    ]
  }
