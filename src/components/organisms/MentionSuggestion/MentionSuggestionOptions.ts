...
import SuggestionList, { type SuggestionListRef } from "../SuggestionList/SuggestionList";
  ...
  items: async ({ query }): Promise<MentionSuggestion[]> =>
    Promise.resolve(
      [
        ...
        // Encontrar entradas correspondentes com base no que o usuário já digitou (após o símbolo @)
        .filter((item) =>
